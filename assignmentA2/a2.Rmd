...
```{r, echo = F}
par(mfrow = c(1,3))
barplot(model.errors[,2], beside = T, main = "MAPE")
barplot(model.errors[,3], beside = T, main = "MAE")
barplot(model.errors[,4], beside = T, main = "RMSE")
```

Assim, além de os terceiro e quartos modelo terem os menores erros o quarto erro vence em duas das métricas e, portanto, faz sentido em ser utilizado. 
