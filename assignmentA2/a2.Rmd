...
Podemos averiguar a comparação de três m´etricas para os erros: 
...
Assim, além de os terceiro e quartos modelo terem os menores erros o quarto erro vence em duas das métricas e, portanto, faz sentido em ser utilizado (em adição aos resíduos terem um comportamento levemente melhor).
