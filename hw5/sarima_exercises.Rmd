...
**Resposta**: Temos a seguinte expressão, usando usando a forma invertida, 

$$
\begin{split}
E\left[(Z_{t+h} - \hat{Z}_t(h))^2\right] = E\left[\left(\sum_{i=1}^{\infty} \pi_iZ_{t+h-i} - \sum_{i=1}^r a_iZ_{t-i}\right)^2\right]
\end{split}
$$
