...
>>>>>>> b13d351305969c30330fc45cfc5c6b3b34a3dc80
...
t.stat <- df.simulation(n,Tr,S,e.sd,phi, intercept = 10)

hist(t.stat, breaks = 50 , freq = F, col = 'grey',
      main = 'Densidade da t-estatística')
```

A distribuição tem uma forma muito similar aquela dos itens anteriores, porém ela tem um intervalo de definição menor do que a dos anteriores. 
