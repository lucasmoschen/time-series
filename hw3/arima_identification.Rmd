...
Antes de identificar o modelo ARIMA, podemos ver pelo gráfico que existe uma variabilidade nos dados. Por esse motivo, é bom visualizarmos alguma transformação que suavize isso. 
