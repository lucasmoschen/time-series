...
First we analyse the MAE using the `rollyapply` again. 
...
prediction = rollapply(t, width = size, arma_model_day)
arma_mae <- mae(o3_train[size:n], prediction[,7])
output(arma_mae, "ARIMA(2,0,3) prediction", prediction[,7], o3_train, dates, size)
```
...
hw_add_model_week = function(t) {
  ...
  #   print(t[1]/n)
  # }
  mod = HoltWinters(ts(o3_train_week[t[1:(size-4)]], frequency = 52), 
                    beta = T, gamma = T, seasonal = "additive")
...
hw_mult_model_week = function(t) {
  ...
  #   print(t[1]/n)
  # }
  mod = HoltWinters(ts(data[t[1:(size-4)]], frequency = 52), 
                    beta = T, gamma = T, seasonal = "multiplicative")
  prediction = forecast(mod, h=4)
  return(as.numeric(prediction$mean))
}
