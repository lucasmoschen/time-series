...
output(stl_add_mae, "Additive decompose prediction", prediction[,7], o3_train, dates, size)
```
...
output(stl_mul_mae, "Multiplicative decompose prediction", exp(prediction[,7]) - 1, o3_train, dates, size)
```
...
output(regression_mae, "Regression prediction", prediction, o3_train, dates, size)
```
...
output(hw_add_mae, "Additive Holt-Winters prediction", prediction[,7], o3_train, dates, size)
```
...
output(hw_mult_mae, "Multiplicative Holt-Winters prediction", prediction[,7] - 1, o3_train, dates, size)
```
...
output(arma_mae, "ARIMA(1,0,2) prediction", prediction[,7], o3_train, dates, size)
```
...
prediction = rollapply(t, width = size, arma_model_day)
arma_mae <- mae(o3_train[size:n], prediction[,7])
output(arma_mae, "ARIMA(3,0,1) prediction", prediction[,7], o3_train, dates, size)
```
...
output_week(stl_add_mae, "Additive decompose prediction", prediction, o3_train_week, dates, size)
```
...
output_week(stl_mul_mae, "Multiplicative decompose prediction", exp(prediction) - 1, o3_train_week, dates, size)
```
...
output_week(hw_add_mae, "Additive Holt-Winters prediction", prediction, o3_train_week, dates, size)
```
...
output_week(hw_mult_mae, "Multiplicative Holt-Winters prediction", prediction - 1, o3_train_week, dates, size)
```
...
output_week(arma_mae, "ARIMA(3,0,1) prediction", prediction, o3_train_week, dates, size)
```
...
prediction = rollapply(t, width = size, arma_model_week)
arma_mae <- mae(o3_train_week[size:n], prediction)
output_week(arma_mae, "ARIMA(2,0,1) prediction", prediction, o3_train_week, dates, size)
```
...
output_week(stl_arma_mae, "STL + ARIMA prediction", prediction, o3_train_week, dates, size)
```
...
output_week(stl_mul_mae, "Multiplicative decompose prediction", exp(prediction) - 1, o3_test_week, dates, size)
```
...
output_week(regression_mae, "Regression prediction", prediction, o3_test_week, dates, size)
```
...
output_week(hw_mult_mae, "Multiplicative Holt-Winters prediction", prediction - 1, o3_test_week, dates, size)
```
...
output(arma_mae, "ARIMA(2,0,1) prediction", prediction, o3_test_week, dates, size)
```
